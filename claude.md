...
- **`frontend-design` skill** at `C:\Users\Apollo\.claude\skills\frontend-design\SKILL.md` — read this before building any web UI. It encodes typography, color, motion, and layout principles for avoiding generic AI aesthetics. Loading it is not optional for design work.
